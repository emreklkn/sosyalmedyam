package com.example.sosyalmedyam.internal;
...
import com.example.sosyalmedyam.widget.SocialView;
...
public final class SocialViewHelper implements SocialView {
  ...
  private static void spanAll(
      Spannable spannable, Pattern pattern, Supplier<CharacterStyle> styleSupplier) {
