...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        //*Bu metod, her bir "ViewHolder" nesnesi için çağrılır ve
        // bu nesnenin görüntülenmesi için gerekli olan verilerin güncellenmesini sağlar.
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            //*Bu kod parçası, bir "ViewHolder" nesnesinin "itemView" özelliğine bir "onClickListener" ekler.
            //*Bu listener, kullanıcının bir kullanıcının profiline tıklaması durumunda çalışır.
    ...
    private void isFollowed(final String id, final Button btnFollow) {
        //*Bu kod parçası, bir kullanıcının takip edilip edilmediğini kontrol etmek için kullanılan "isFollowed" adlı bir metodu tanımlar.
    ...
    private void addNotification(String userId) {
        //* "addNotification" adlı bir metod tanımlar. Bu metod, Firebase veritabanında yeni bir bildirim oluşturmak için kullanılır.
