...
import com.example.sosyalmedyam.cropper.CropImageView;
...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //* aşağıda kodlar kullanıcının bilgilerini almak için
        ...
        changePhoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //* crop image kütüphanesini kullanarak fotoğraflaro ayarlamamızı sağlar
    ...
    private void uploadImage() {
        //* fotoğraf eklemek için kullanılır
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        //*bu kod resim seçme kesme aktivitisinin sonucunu işlemek için kullanılır
